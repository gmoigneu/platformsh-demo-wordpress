...
jQuery(document).ready(function(){"use strict";function e(){"1"==ecko_theme_vars.general_hidecomments&&(jQuery(".comments-show").show(),jQuery(".post-comments").hide(),jQuery(".comments-show").on("click",function(){jQuery(".comments-show").slideUp(),jQuery(".post-comments").slideDown()}))}function i(){"1"!==ecko_theme_vars.general_disable_syntax_highlighter&&Rainbow.color()}function n(){jQuery(".page-content").hasClass("sidebar-open")&&(jQuery(".toggle-sidebar i").removeClass("fa-close").addClass("fa-navicon"),jQuery(".page-content").removeClass("sidebar-open"),jQuery(".page-sidebar").removeClass("sidebar-open"),jQuery(".header-mobile").removeClass("sidebar-open"))}function a(){jQuery(".page-content").hasClass("sidebar-open")||(jQuery(".toggle-sidebar i").removeClass("fa-navicon").addClass("fa-close"),jQuery(".page-wrapper").addClass("sidebar-open"),jQuery(".page-content").addClass("sidebar-open"),jQuery(".page-sidebar").addClass("sidebar-open"),jQuery(".header-mobile").addClass("sidebar-open"))}function t(){"1"!==ecko_theme_vars.layout_disable_sticky_sidebar&&(jQuery("body").hasClass("layout-sidebar-hidden")||(jQuery(".page-sidebar").height()<jQuery(".page-content").height()&&jQuery(".page-sidebar").css("height",window.innerHeight),jQuery(".page-sidebar-sticky").stick_in_parent({bottoming:!1})))}function r(){jQuery(".page-content").height()>jQuery(".page-sidebar").height()&&(jQuery("body").hasClass("layout-sidebar-right")?jQuery(".page-wrapper").css("border-right","1px solid #f0f0f1"):jQuery(".page-wrapper").css("border-left","1px solid #f0f0f1"),jQuery(".page-sidebar").css("border","0"))}function o(){jQuery(".widget.navigation li.menu-item-has-children > a").each(function(){jQuery(this).html(jQuery(this).text()+'<i class="fa fa-chevron-down"></i>')})}function s(){jQuery(".required.email").attr("placeholder",ecko_theme_vars.localization_email_address+"..."),jQuery(".widget.subscribe .inner form").append('<i class="fa fa-envelope-o subscribe-icon"></i><i class="fa fa-arrow-right subscribe-submit"></i>'),jQuery(".post-item-subscribe .post-info form").append('<i class="fa fa-arrow-right subscribe-submit"></i>'),jQuery(".subscribe-submit").click(function(){jQuery(this).parent("form").submit()})}function u(){if("1"!==ecko_theme_vars.pagination_disable_infinite_loading&&(jQuery(".pagination-default").hide(),jQuery(".pagination-infinite").show(),jQuery(".pagination").length>0))if(jQuery(".pagination-previous").length>0){new Waypoint({element:jQuery(".pagination")[0],handler:function(e){"down"==e&&c()},offset:"100%"})}else jQuery(".pagination-ajax").html('<i class="fa fa-info"></i> '+ecko_theme_vars.localization_no_more_posts)}function c(e){jQuery(".pagination-previous").length>0&&jQuery.get(jQuery(".pagination-previous").attr("href"),function(e){var i=jQuery(e).find(".post-item"),n=jQuery(e).find(".pagination-previous").attr("href");jQuery(i).addClass("post-item-new"),jQuery(".post-list-container").append(i),jQuery(".post-item-subscribe").not(":first").remove(),Waypoint.refreshAll(),jQuery(".post-item-new").each(function(e){var i=this;setTimeout(function(){jQuery(i).css("opacity",1),jQuery(i).removeClass("post-item-new")},250*e)}),void 0!==n?jQuery(".pagination-previous").attr("href",n):(jQuery(".pagination-previous").remove(),jQuery(".pagination-ajax").html('<i class="fa fa-info"></i> '+ecko_theme_vars.localization_no_more_posts))})}!function(){i(),e(),r(),o(),s(),u(),window.innerWidth>1300&&(t(),setTimeout(function(){jQuery(window).scrollTop(jQuery(window).scrollTop()+1)},100))}(),jQuery(window).load(function(){}),jQuery(window).resize(function(){this.resizeTO&&clearTimeout(this.resizeTO),this.resizeTO=setTimeout(function(){jQuery(this).trigger("resizeEnd")},500)}),jQuery(window).bind("resizeEnd",function(){window.innerWidth<1300&&(jQuery(".page-sidebar-sticky").trigger("sticky_kit:detach"),jQuery(".page-sidebar").height()<jQuery(".page-content")&&jQuery(".page-sidebar").css("height",window.innerHeight)),window.innerWidth>1300&&(t(),n())}),jQuery(".toggle-sidebar").click(function(){jQuery(".page-content").hasClass("sidebar-open")?n():a()}),jQuery(".sidebar-close").click(function(){n()}),jQuery(".widget.navigation li.menu-item-has-children > a").on("click",function(){var e=jQuery(this).parent();return jQuery("a i",e).toggleClass("fa-chevron-down"),jQuery("a i",e).toggleClass("fa-chevron-up"),jQuery(".sub-menu",e).slideToggle(function(){jQuery(".page-sidebar-sticky").trigger("sticky_kit:recalc")}),!1}),jQuery("li.menu-item-has-children").on("click","a",function(){return"#"==jQuery(this).attr("href")?!1:void 0}),jQuery(".searchform .submit").click(function(){jQuery(this).parent("form").submit()}),jQuery(".postcontents").fitVids(),jQuery(".postcontents-image").magnificPopup({type:"image",closeOnContentClick:!0,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},zoom:{enabled:!0,duration:300}}),jQuery(".postcontents a").each(function(){jQuery(this).attr("href").match(/\.(jpg|png|gif)/g)&&jQuery(this).magnificPopup({type:"image",closeOnContentClick:!0,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},gallery:{enabled:!0},zoom:{enabled:!0,duration:300}})}),jQuery(".eckogallery, .gallery").each(function(){jQuery(this).magnificPopup({delegate:"a",type:"image",mainClass:"mfp-no-margins mfp-with-zoom",gallery:{enabled:!0},image:{verticalFit:!0},zoom:{enabled:!0,duration:300}})}),jQuery(".postcontents .eckogallery").justifiedGallery({rowHeight:160,maxRowHeight:220,margins:3,border:0,lastRow:"justify",captions:!1,cssAnimation:!0,imagesAnimationDuration:300})});